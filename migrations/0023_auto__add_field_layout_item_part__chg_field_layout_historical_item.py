...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layout.item_part'
        db.add_column('digipal_layout', 'item_part',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='layouts', null=True, to=orm['digipal.ItemPart']),
                      keep_default=False)


        # Changing field 'Layout.historical_item'
        db.alter_column('digipal_layout', 'historical_item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['digipal.HistoricalItem'], null=True))

    def backwards(self, orm):
        # Deleting field 'Layout.item_part'
        db.delete_column('digipal_layout', 'item_part_id')


        # Changing field 'Layout.historical_item'
        db.alter_column('digipal_layout', 'historical_item_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['digipal.HistoricalItem']))
