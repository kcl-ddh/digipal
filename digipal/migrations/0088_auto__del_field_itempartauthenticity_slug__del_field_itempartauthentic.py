...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ItemPartAuthenticity.slug'
        db.delete_column(u'digipal_itempartauthenticity', 'slug')

        # Deleting field 'ItemPartAuthenticity.name'
        db.delete_column(u'digipal_itempartauthenticity', 'name')


    def backwards(self, orm):
        # Adding field 'ItemPartAuthenticity.slug'
        db.add_column(u'digipal_itempartauthenticity', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'ItemPartAuthenticity.name'
        db.add_column(u'digipal_itempartauthenticity', 'name',
