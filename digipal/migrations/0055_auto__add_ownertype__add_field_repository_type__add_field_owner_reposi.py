...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'digipal_ownertype', (
        ...
        db.send_create_signal(u'digipal', ['OwnerType'])

        # Adding field 'Repository.type'
        db.add_column(u'digipal_repository', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='repositories', null=True, blank=True, to=orm['digipal.OwnerType']),
                      keep_default=False)

        # Adding field 'Owner.repository'
        db.add_column(u'digipal_owner', 'repository',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='owners', null=True, blank=True, to=orm['digipal.Repository']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OwnerType'
        db.delete_table(u'digipal_ownertype')

        # Deleting field 'Repository.type'
        db.delete_column(u'digipal_repository', 'type_id')

        # Deleting field 'Owner.repository'
        db.delete_column(u'digipal_owner', 'repository_id')
