...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemOrigin.place'
        db.add_column(u'digipal_itemorigin', 'place',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='item_origins', null=True, to=orm['digipal.Place']),
                      keep_default=False)

        # Adding field 'ItemOrigin.institution'
        db.add_column(u'digipal_itemorigin', 'institution',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='item_origins', null=True, to=orm['digipal.Institution']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemOrigin.place'
        db.delete_column(u'digipal_itemorigin', 'place_id')

        # Deleting field 'ItemOrigin.institution'
        db.delete_column(u'digipal_itemorigin', 'institution_id')
