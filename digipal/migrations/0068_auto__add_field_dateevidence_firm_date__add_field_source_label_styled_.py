...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'digipal_dateevidence', 'firm_date',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='firm_evidences', null=True, to=orm['digipal.Date']),
                      keep_default=False)

        # Adding field 'Source.label_styled'
        db.add_column(u'digipal_source', 'label_styled',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Source.label'
        db.alter_column(u'digipal_source', 'label', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, null=True))

    def backwards(self, orm):
        # Deleting field 'DateEvidence.firm_date'
        db.delete_column(u'digipal_dateevidence', 'firm_date_id')

        # Deleting field 'Source.label_styled'
        db.delete_column(u'digipal_source', 'label_styled')


        # Changing field 'Source.label'
        db.alter_column(u'digipal_source', 'label', self.gf('django.db.models.fields.CharField')(unique=True, max_length=12, null=True))
    ...
    models = {
        ...
        u'digipal.dateevidence': {
            ...
            'evidence': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'firm_date': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'firm_evidences'", 'null': 'True', 'to': u"orm['digipal.Date']"}),
        ...
        u'digipal.source': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '20', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'label_styled': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
