...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'digipal_dateevidence', 'evidence', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'DateEvidence.evidence'
        db.alter_column(u'digipal_dateevidence', 'evidence', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
