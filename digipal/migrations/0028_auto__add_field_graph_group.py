...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Graph.group'
        db.add_column('digipal_graph', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parts', null=True, to=orm['digipal.Graph']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Graph.group'
        db.delete_column('digipal_graph', 'group_id')
