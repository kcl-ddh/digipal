...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DateEvidence.evidence'
        db.alter_column('digipal_dateevidence', 'evidence', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Scribe.legacy_reference'
        db.alter_column('digipal_scribe', 'legacy_reference', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Date.evidence'
        db.alter_column('digipal_date', 'evidence', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Date.legacy_reference'
        db.alter_column('digipal_date', 'legacy_reference', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'HistoricalItem.legacy_reference'
        db.alter_column('digipal_historicalitem', 'legacy_reference', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'DateEvidence.evidence'
        db.alter_column('digipal_dateevidence', 'evidence', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Scribe.legacy_reference'
        db.alter_column('digipal_scribe', 'legacy_reference', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Date.evidence'
        db.alter_column('digipal_date', 'evidence', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Date.legacy_reference'
        db.alter_column('digipal_date', 'legacy_reference', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'HistoricalItem.legacy_reference'
        db.alter_column('digipal_historicalitem', 'legacy_reference', self.gf('django.db.models.fields.CharField')(max_length=128))
