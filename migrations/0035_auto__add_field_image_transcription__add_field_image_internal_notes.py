...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.transcription'
        db.add_column('digipal_image', 'transcription',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.internal_notes'
        db.add_column('digipal_image', 'internal_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.transcription'
        db.delete_column('digipal_image', 'transcription')

        # Deleting field 'Image.internal_notes'
        db.delete_column('digipal_image', 'internal_notes')
