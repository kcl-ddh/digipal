...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextContentXMLStatus.sort_order'
        db.add_column(u'digipal_text_textcontentxmlstatus', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextContentXMLStatus.sort_order'
        db.delete_column(u'digipal_text_textcontentxmlstatus', 'sort_order')
