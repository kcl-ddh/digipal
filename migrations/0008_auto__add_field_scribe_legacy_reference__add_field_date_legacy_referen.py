...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('digipal_dateevidence', 'evidence', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Adding field 'Scribe.legacy_reference'
        db.add_column('digipal_scribe', 'legacy_reference',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Date.legacy_reference'
        db.add_column('digipal_date', 'legacy_reference',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Date.evidence'
        db.add_column('digipal_date', 'evidence',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalItem.legacy_reference'
        db.add_column('digipal_historicalitem', 'legacy_reference',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DateEvidence.evidence'
        db.alter_column('digipal_dateevidence', 'evidence', self.gf('django.db.models.fields.CharField')(max_length=128))
        # Deleting field 'Scribe.legacy_reference'
        db.delete_column('digipal_scribe', 'legacy_reference')

        # Deleting field 'Date.legacy_reference'
        db.delete_column('digipal_date', 'legacy_reference')

        # Deleting field 'Date.evidence'
        db.delete_column('digipal_date', 'evidence')

        # Deleting field 'HistoricalItem.legacy_reference'
        db.delete_column('digipal_historicalitem', 'legacy_reference')
    ...
    models = {
        ...
        'digipal.date': {
            ...
            'evidence': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'legacy_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'legacy_reference': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'blank': 'True'}),
        ...
        'digipal.dateevidence': {
            ...
            'evidence': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
