...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ItemPart.historical_item'
        db.delete_column('digipal_itempart', 'historical_item_id')


    def backwards(self, orm):
        # Adding field 'ItemPart.historical_item'
        db.add_column('digipal_itempart', 'historical_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['digipal.HistoricalItem']),
                      keep_default=False)
