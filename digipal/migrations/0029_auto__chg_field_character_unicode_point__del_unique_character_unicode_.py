...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Character', fields ['unicode_point']
        db.delete_unique('digipal_character', ['unicode_point'])


        # Changing field 'Character.unicode_point'
        db.alter_column('digipal_character', 'unicode_point', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
        # Adding field 'Ontograph.nesting_level'
        db.add_column('digipal_ontograph', 'nesting_level',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Character.unicode_point'
        db.alter_column('digipal_character', 'unicode_point', self.gf('django.db.models.fields.CharField')(default=0, max_length=32, unique=True))
        # Adding unique constraint on 'Character', fields ['unicode_point']
        db.create_unique('digipal_character', ['unicode_point'])

        # Deleting field 'Ontograph.nesting_level'
        db.delete_column('digipal_ontograph', 'nesting_level')
