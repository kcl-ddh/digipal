...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.page_boundaries'
        db.add_column(u'digipal_image', 'page_boundaries',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.page_boundaries'
        db.delete_column(u'digipal_image', 'page_boundaries')
