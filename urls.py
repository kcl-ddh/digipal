...
urlpatterns = patterns('digipal.views.annotation',
                       ...
                       (r'^page/(?P<image_id>\d+)/graph/(?P<graph_id>\d+)/(?P<character>\w+)/allographs_by_graph/$', 'get_allographs_by_graph'),
                       (r'^page/(?P<image_id>\d+)/allographs/(?P<allograph_id>\d+)/(?P<character>\w+)/allographs_by_allograph/$', 'get_allographs_by_allograph'),
