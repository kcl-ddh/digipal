...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StewartRecord'
        db.create_table('digipal_stewartrecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('scragg', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('repository', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('shelf_mark', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('stokes', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('fols', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('gneuss', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('sp', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('ker', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('hand', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('locus', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('selected', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('adate', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('surrogates', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('contents', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('notes', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('em', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('glosses', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('minor', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('charter', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('cartulary', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('eel', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal('digipal', ['StewartRecord'])


    def backwards(self, orm):
        # Deleting model 'StewartRecord'
        db.delete_table('digipal_stewartrecord')
    ...
    models = {
        ...
        'digipal.stewartrecord': {
            ...
            'adate': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'cartulary': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'charter': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'contents': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'eel': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'em': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'fols': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'glosses': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'gneuss': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'hand': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ker': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'locus': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'minor': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'notes': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'repository': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'scragg': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'selected': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'shelf_mark': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'sp': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'stokes': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'surrogates': ('django.db.models.fields.CharField', [], {'max_length': '300'})
        }
    }
