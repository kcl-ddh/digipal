...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImageAnnotationStatus'
        db.create_table('digipal_imageannotationstatus', (
        ...
        db.send_create_signal('digipal', ['ImageAnnotationStatus'])

        # Adding field 'Image.annotation_status'
        db.add_column('digipal_image', 'annotation_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', null=True, to=orm['digipal.ImageAnnotationStatus']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ImageAnnotationStatus'
        db.delete_table('digipal_imageannotationstatus')

        # Deleting field 'Image.annotation_status'
        db.delete_column('digipal_image', 'annotation_status_id')
    ...
    models = {
        ...
        'digipal.image': {
            ...
            'annotation_status': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'null': 'True', 'to': "orm['digipal.ImageAnnotationStatus']"}),
