...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('digipal_carouselitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('image_alt', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
            ('image_title', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
        ...
        db.send_create_signal('digipal', ['CarouselItem'])


    def backwards(self, orm):
        # Deleting model 'CarouselItem'
        db.delete_table('digipal_carouselitem')
