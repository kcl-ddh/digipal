...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CatalogueNumber.number_slug'
        db.add_column(u'digipal_cataloguenumber', 'number_slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source.label_slug'
        db.add_column(u'digipal_source', 'label_slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CatalogueNumber.number_slug'
        db.delete_column(u'digipal_cataloguenumber', 'number_slug')

        # Deleting field 'Source.label_slug'
        db.delete_column(u'digipal_source', 'label_slug')
