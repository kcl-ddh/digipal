...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EntryHand'
        db.create_table(u'digipal_text_entryhand', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item_part', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entry_hands', to=orm['digipal.ItemPart'])),
            ('entry_number', self.gf('django.db.models.fields.CharField')(max_length=20, db_index=True)),
            ('hand_label', self.gf('django.db.models.fields.CharField')(max_length=20, db_index=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True)),
            ('correction', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('certainty', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'digipal_text', ['EntryHand'])

        # Adding unique constraint on 'EntryHand', fields ['item_part', 'entry_number', 'hand_label', 'order', 'correction']
        db.create_unique(u'digipal_text_entryhand', ['item_part_id', 'entry_number', 'hand_label', 'order', 'correction'])


    def backwards(self, orm):
        # Removing unique constraint on 'EntryHand', fields ['item_part', 'entry_number', 'hand_label', 'order', 'correction']
        db.delete_unique(u'digipal_text_entryhand', ['item_part_id', 'entry_number', 'hand_label', 'order', 'correction'])

        # Deleting model 'EntryHand'
        db.delete_table(u'digipal_text_entryhand')
