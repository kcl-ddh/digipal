...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Description.comments'
        db.add_column('digipal_description', 'comments',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Description.summary'
        db.add_column('digipal_description', 'summary',
        ...
        # Adding field 'TextItemPart.date'
        db.add_column('digipal_textitempart', 'date',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Description.comments'
        db.delete_column('digipal_description', 'comments')

        # Deleting field 'Description.summary'
        db.delete_column('digipal_description', 'summary')


        # Changing field 'Description.description'
        db.alter_column('digipal_description', 'description', self.gf('django.db.models.fields.TextField')(default=' '))
        # Deleting field 'TextItemPart.date'
        db.delete_column('digipal_textitempart', 'date')
