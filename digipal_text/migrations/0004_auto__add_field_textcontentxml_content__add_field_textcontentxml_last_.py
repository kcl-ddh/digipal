...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextContentXML.content'
        db.add_column(u'digipal_text_textcontentxml', 'content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TextContentXML.last_image'
        db.add_column(u'digipal_text_textcontentxml', 'last_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='text_content_xmls', null=True, to=orm['digipal.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextContentXML.content'
        db.delete_column(u'digipal_text_textcontentxml', 'content')

        # Deleting field 'TextContentXML.last_image'
        db.delete_column(u'digipal_text_textcontentxml', 'last_image_id')
