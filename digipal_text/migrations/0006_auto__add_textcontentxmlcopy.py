...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TextContentXMLCopy'
        db.create_table(u'digipal_text_textcontentxmlcopy', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='versions', null=True, to=orm['digipal_text.TextContentXML'])),
            ('content', self.gf('django.db.models.fields.BinaryField')(null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'digipal_text', ['TextContentXMLCopy'])


    def backwards(self, orm):
        # Deleting model 'TextContentXMLCopy'
        db.delete_table(u'digipal_text_textcontentxmlcopy')
