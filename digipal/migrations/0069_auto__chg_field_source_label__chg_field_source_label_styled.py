...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'digipal_source', 'label', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True, null=True))

        # Changing field 'Source.label_styled'
        db.alter_column(u'digipal_source', 'label_styled', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'Source.label'
        db.alter_column(u'digipal_source', 'label', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20, null=True))

        # Changing field 'Source.label_styled'
        db.alter_column(u'digipal_source', 'label_styled', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
