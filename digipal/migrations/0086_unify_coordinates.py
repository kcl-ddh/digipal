    ...
    if geo_json:
        ...
        if 'geometry' in geo_json:
            ...
            if height:
                ...
                print 'WARNING: image #%s.height is undefined' % annotation.image.id
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        c = 0
        for annotation in orm['digipal.Annotation'].objects.filter(graph__isnull=True).select_related('image'):
            c += 1
            correct_geometry(annotation)
            annotation.save()

        print 'Converted %s annotations.' % c
