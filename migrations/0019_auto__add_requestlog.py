...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('digipal_requestlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('request', self.gf('django.db.models.fields.CharField')(default='', max_length=300, null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('result_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('digipal', ['RequestLog'])


    def backwards(self, orm):
        # Deleting model 'RequestLog'
        db.delete_table('digipal_requestlog')
