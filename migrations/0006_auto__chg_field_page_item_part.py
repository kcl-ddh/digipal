...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Page.item_part'
        db.alter_column('digipal_page', 'item_part_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['digipal.ItemPart']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Page.item_part'
        raise RuntimeError("Cannot reverse this migration. 'Page.item_part' and its values cannot be restored.")
