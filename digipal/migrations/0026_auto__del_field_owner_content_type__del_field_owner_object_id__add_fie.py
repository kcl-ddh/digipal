...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Owner.content_type'
        db.delete_column('digipal_owner', 'content_type_id')

        # Deleting field 'Owner.object_id'
        db.delete_column('digipal_owner', 'object_id')

        # Adding field 'Owner.person'
        db.add_column('digipal_owner', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='owners', null=True, blank=True, to=orm['digipal.Person']),
                      keep_default=False)

        # Adding field 'Owner.institution'
        db.add_column('digipal_owner', 'institution',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='owners', null=True, blank=True, to=orm['digipal.Institution']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Owner.content_type'
        db.add_column('digipal_owner', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Owner.object_id'
        db.add_column('digipal_owner', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None),
                      keep_default=False)

        # Deleting field 'Owner.person'
        db.delete_column('digipal_owner', 'person_id')

        # Deleting field 'Owner.institution'
        db.delete_column('digipal_owner', 'institution_id')
