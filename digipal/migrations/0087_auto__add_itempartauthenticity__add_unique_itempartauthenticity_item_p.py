...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ItemPartAuthenticity'
        db.create_table(u'digipal_itempartauthenticity', (
            ...
            ('item_part', self.gf('django.db.models.fields.related.ForeignKey')(related_name='authenticity', to=orm['digipal.ItemPart'])),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='itempart_authenticity', to=orm['digipal.AuthenticityCategory'])),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='itempart_authenticity', null=True, to=orm['digipal.Source'])),
            ('note', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal(u'digipal', ['ItemPartAuthenticity'])

        # Adding unique constraint on 'ItemPartAuthenticity', fields ['item_part', 'category', 'source']
        db.create_unique(u'digipal_itempartauthenticity', ['item_part_id', 'category_id', 'source_id'])

        # Adding model 'AuthenticityCategory'
        db.create_table(u'digipal_authenticitycategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=100)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal(u'digipal', ['AuthenticityCategory'])


    def backwards(self, orm):
        # Removing unique constraint on 'ItemPartAuthenticity', fields ['item_part', 'category', 'source']
        db.delete_unique(u'digipal_itempartauthenticity', ['item_part_id', 'category_id', 'source_id'])

        # Deleting model 'ItemPartAuthenticity'
        db.delete_table(u'digipal_itempartauthenticity')

        # Deleting model 'AuthenticityCategory'
        db.delete_table(u'digipal_authenticitycategory')
    ...
    models = {
        ...
        u'digipal.itempartauthenticity': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_part': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'authenticity'", 'to': u"orm['digipal.ItemPart']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
