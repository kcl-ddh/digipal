...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextContentXMLCopy.ahash'
        db.add_column(u'digipal_text_textcontentxmlcopy', 'ahash',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextContentXMLCopy.ahash'
        db.delete_column(u'digipal_text_textcontentxmlcopy', 'ahash')
