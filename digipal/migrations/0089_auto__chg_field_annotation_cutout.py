...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Annotation.cutout'
        db.alter_column(u'digipal_annotation', 'cutout', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Annotation.cutout'
        db.alter_column(u'digipal_annotation', 'cutout', self.gf('django.db.models.fields.CharField')(default=None, max_length=256))
