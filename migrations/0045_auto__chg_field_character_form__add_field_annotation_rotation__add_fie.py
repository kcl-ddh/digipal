...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('digipal_character', 'form_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['digipal.CharacterForm']))
        # Adding field 'Annotation.rotation'
        db.add_column('digipal_annotation', 'rotation',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Image.width'
        db.add_column('digipal_image', 'width',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Image.height'
        db.add_column('digipal_image', 'height',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Annotation.rotation'
        db.delete_column('digipal_annotation', 'rotation')

        # Deleting field 'Image.width'
        db.delete_column('digipal_image', 'width')

        # Deleting field 'Image.height'
        db.delete_column('digipal_image', 'height')
