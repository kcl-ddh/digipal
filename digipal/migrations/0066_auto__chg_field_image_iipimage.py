...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.iipimage'
        db.alter_column(u'digipal_image', 'iipimage', self.gf('iipimage.fields.ImageField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Image.iipimage'
        db.alter_column(u'digipal_image', 'iipimage', self.gf('iipimage.fields.ImageField')(max_length=100, null=True))
