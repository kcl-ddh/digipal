...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename model 'Page' to 'Image'
        db.rename_table('digipal_page', 'digipal_image')
        db.rename_table('digipal_hand_pages', 'digipal_hand_images')
        db.rename_column('digipal_annotation', 'page_id', 'image_id')
        db.rename_column('digipal_hand_images', 'page_id', 'image_id')

        # Adding model 'ItemPartItem'
        db.create_table('digipal_itempartitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('historical_item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='partitions', to=orm['digipal.HistoricalItem'])),
            ('item_part', self.gf('django.db.models.fields.related.ForeignKey')(related_name='constitutionalities', to=orm['digipal.ItemPart'])),
            ('locus', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('digipal', ['ItemPartItem'])

        # Adding model 'ItemPartType'
        db.create_table('digipal_itemparttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('digipal', ['ItemPartType'])

        # Adding field 'ItemPart.group'
        db.add_column('digipal_itempart', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='subdivisions', null=True, to=orm['digipal.ItemPart']),
                      keep_default=False)

        # Adding field 'ItemPart.type'
        db.add_column('digipal_itempart', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['digipal.ItemPartType'], null=True),
                      keep_default=False)

        # Adding unique constraint on 'Annotation', fields ['image', 'vector_id']
        db.create_unique('digipal_annotation', ['image_id', 'vector_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'Annotation', fields ['image', 'vector_id']
        db.delete_unique('digipal_annotation', ['image_id', 'vector_id'])

        # Rename model 'Page' to 'Image'
        db.rename_table('digipal_image', 'digipal_page')
        db.rename_table('digipal_hand_images', 'digipal_hand_pages')
        db.rename_column('digipal_annotation', 'image_id', 'page_id')
        db.rename_column('digipal_hand_pages', 'image_id', 'page_id')

        # Deleting model 'ItemPartItem'
        db.delete_table('digipal_itempartitem')

        # Deleting model 'ItemPartType'
        db.delete_table('digipal_itemparttype')

        # Deleting field 'ItemPart.group'
        db.delete_column('digipal_itempart', 'group_id')

        # Deleting field 'ItemPart.type'
        db.delete_column('digipal_itempart', 'type_id')
    ...
    models = {
        ...
        'digipal.itempart': {
            ...
            'display_label': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subdivisions'", 'null': 'True', 'to': "orm['digipal.ItemPart']"}),
            'historical_item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['digipal.HistoricalItem']"}),
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['digipal.ItemPartType']", 'null': 'True'})
        },
        'digipal.itempartitem': {
            'Meta': {'object_name': 'ItemPartItem'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
