...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for page in orm['digipal.Page'].objects.all():
            ...
            page.folio_number = None
            matches = re.findall(r'\d+', num_side)
            if matches: page.folio_number = matches[0]
            
            page.folio_side = None
            matches = re.findall(r'(?:^|\d)(r[a-z]?|v[a-z]?|recto|verso|face|dorse)', num_side)
            if matches: 
                page.folio_side = matches[0]
            
            if page.folio_side and re.match('(?i)face|dorse', page.folio_side): page.folio_number = 0                
            if page.folio_side and re.match('(?i)face', page.folio_side): page.folio_side = 'r'
