...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextContent.text'
        db.add_column(u'digipal_text_textcontent', 'text',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='text_contents', null=True, to=orm['digipal.Text']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextContent.text'
        db.delete_column(u'digipal_text_textcontent', 'text_id')
