...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Annotation.clientid'
        db.add_column(u'digipal_annotation', 'clientid',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=24, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Annotation.clientid'
        db.delete_column(u'digipal_annotation', 'clientid')
