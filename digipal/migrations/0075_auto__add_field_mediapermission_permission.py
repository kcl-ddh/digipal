...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaPermission.permission'
        db.add_column(u'digipal_mediapermission', 'permission',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaPermission.permission'
        db.delete_column(u'digipal_mediapermission', 'permission')
