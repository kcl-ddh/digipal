...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Annotation.type'
        db.add_column(u'digipal_annotation', 'type',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=15, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Annotation.type'
        db.delete_column(u'digipal_annotation', 'type')
