...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm['digipal.OwnerType'](name='Person', id=1).save()
        orm['digipal.OwnerType'](name='Institution', id=2).save()
        orm['digipal.OwnerType'](name='Library', id=3).save()
        orm['digipal.OwnerType'](name='Unknown', id=4).save()
