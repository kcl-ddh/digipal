...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('digipal_carouselitem', 'image', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'CarouselItem.link'
        db.alter_column('digipal_carouselitem', 'link', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'CarouselItem.image'
        db.alter_column('digipal_carouselitem', 'image', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'CarouselItem.link'
        db.alter_column('digipal_carouselitem', 'link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
