...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.copyright_notice'
        db.add_column('digipal_repository', 'copyright_notice',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.copyright_notice'
        db.delete_column('digipal_repository', 'copyright_notice')
