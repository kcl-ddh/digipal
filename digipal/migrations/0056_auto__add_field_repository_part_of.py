...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.part_of'
        db.add_column(u'digipal_repository', 'part_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='parts', null=True, blank=True, to=orm['digipal.Repository']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.part_of'
        db.delete_column(u'digipal_repository', 'part_of_id')
