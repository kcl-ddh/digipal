...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ItemOrigin.content_type'
        db.delete_column(u'digipal_itemorigin', 'content_type_id')

        # Deleting field 'ItemOrigin.object_id'
        db.delete_column(u'digipal_itemorigin', 'object_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ItemOrigin.content_type'
        raise RuntimeError("Cannot reverse this migration. 'ItemOrigin.content_type' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ItemOrigin.object_id'
        raise RuntimeError("Cannot reverse this migration. 'ItemOrigin.object_id' and its values cannot be restored.")
