...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TextAnnotation'
        db.create_table(u'digipal_text_textannotation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('annotation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['digipal.Annotation'])),
            ('elementid', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'digipal_text', ['TextAnnotation'])

        # Adding unique constraint on 'TextAnnotation', fields ['annotation', 'elementid']
        db.create_unique(u'digipal_text_textannotation', ['annotation_id', 'elementid'])


    def backwards(self, orm):
        # Removing unique constraint on 'TextAnnotation', fields ['annotation', 'elementid']
        db.delete_unique(u'digipal_text_textannotation', ['annotation_id', 'elementid'])

        # Deleting model 'TextAnnotation'
        db.delete_table(u'digipal_text_textannotation')
    ...
    models = {
        ...
        u'digipal_text.textannotation': {
            ...
            'annotation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['digipal.Annotation']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'digipal_text.textcontenttype': {
            'Meta': {'ordering': "['name']", 'object_name': 'TextContentType'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'digipal_text.textcontentxmlcopy': {
            'Meta': {'object_name': 'TextContentXMLCopy'},
            'ahash': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'content': ('django.db.models.fields.BinaryField', [], {'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
