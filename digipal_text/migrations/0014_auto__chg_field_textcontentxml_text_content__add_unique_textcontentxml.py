...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TextContentXML.text_content'
        db.alter_column(u'digipal_text_textcontentxml', 'text_content_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['digipal_text.TextContent']))
        # Adding unique constraint on 'TextContentXML', fields ['text_content']
        db.create_unique(u'digipal_text_textcontentxml', ['text_content_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TextContentXML', fields ['text_content']
        db.delete_unique(u'digipal_text_textcontentxml', ['text_content_id'])


        # Changing field 'TextContentXML.text_content'
        db.alter_column(u'digipal_text_textcontentxml', 'text_content_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['digipal_text.TextContent']))
