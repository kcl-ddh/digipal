...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # 1. one HI to many IP becomes many2many
        for part in orm['digipal.ItemPart'].objects.all():
            item_part_item = orm['digipal.ItemPartItem']()
            item_part_item.historical_item = part.historical_item
            item_part_item.item_part = part
            item_part_item.save()

        # 2. Nested IP
        # Nothing to do here. We decide not to convert Page into Item Part.
        #
        # Reasons:
        #    For each Page we have an additional Item Part record which is unused.
        #    It makes the editing and the search/browse more complex
        # 
        
        # 3. Page -> Image
        # Nothing to do, the model has been renamed
        #
