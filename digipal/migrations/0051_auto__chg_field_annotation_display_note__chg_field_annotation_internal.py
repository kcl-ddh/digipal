...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Annotation.display_note'
        db.alter_column(u'digipal_annotation', 'display_note', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'Annotation.internal_note'
        db.alter_column(u'digipal_annotation', 'internal_note', self.gf('tinymce.models.HTMLField')(null=True))

    def backwards(self, orm):

        # Changing field 'Annotation.display_note'
        db.alter_column(u'digipal_annotation', 'display_note', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Annotation.internal_note'
        db.alter_column(u'digipal_annotation', 'internal_note', self.gf('django.db.models.fields.TextField')(null=True))
