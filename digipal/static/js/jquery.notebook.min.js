    ...
    var o, a = function() {
        ...
        u = {
            ...
            show: function() {
                ...
                t.length || (t = d.html.addTag(e(this).parent().parent().find('#notes_tab'), "div", !1, !1), t.addClass("jquery-notebook bubble")), t.empty(), u.buildMenu(this, t), t.show(), u.updateState(this, t), t.hasClass("active") ? t.removeClass("jump") : t.addClass("jump"), u.updatePos(e(this), t), t.addClass("active")
            },
            update: function() {
                var t = e(this).parent().parent().find(".bubble");
