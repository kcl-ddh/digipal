...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'digipal_dateevidence', 'historical_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='date_evidences', null=True, to=orm['digipal.HistoricalItem']),
                      keep_default=False)
        ...
        # Adding field 'PlaceEvidence.historical_item'
        db.add_column(u'digipal_placeevidence', 'historical_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['digipal.HistoricalItem'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlaceEvidence.written_as'
        db.add_column(u'digipal_placeevidence', 'written_as',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


        # Changing field 'PlaceEvidence.hand'
        db.alter_column(u'digipal_placeevidence', 'hand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['digipal.Hand'], null=True))
        # Adding field 'Place.other_names'
        db.add_column(u'digipal_place', 'other_names',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DateEvidence.hand'
        db.alter_column(u'digipal_dateevidence', 'hand_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['digipal.Hand']))
        # Deleting field 'PlaceEvidence.historical_item'
        db.delete_column(u'digipal_placeevidence', 'historical_item_id')

        # Deleting field 'PlaceEvidence.written_as'
        db.delete_column(u'digipal_placeevidence', 'written_as')


        # Changing field 'PlaceEvidence.hand'
        db.alter_column(u'digipal_placeevidence', 'hand_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['digipal.Hand']))
        # Deleting field 'Place.other_names'
        db.delete_column(u'digipal_place', 'other_names')
