...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('digipal_stewartrecord', 'em', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'StewartRecord.contents'
        db.alter_column('digipal_stewartrecord', 'contents', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'StewartRecord.notes'
        db.alter_column('digipal_stewartrecord', 'notes', self.gf('django.db.models.fields.CharField')(max_length=600, null=True))

        # Changing field 'StewartRecord.eel'
        db.alter_column('digipal_stewartrecord', 'eel', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
