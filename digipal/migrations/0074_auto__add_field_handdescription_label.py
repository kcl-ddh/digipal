...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HandDescription.label'
        db.add_column(u'digipal_handdescription', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HandDescription.label'
        db.delete_column(u'digipal_handdescription', 'label')
