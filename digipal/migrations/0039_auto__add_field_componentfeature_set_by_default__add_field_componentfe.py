...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('digipal_component_features', 'set_by_default')

        # Deleting field 'ComponentFeature.created'
        db.delete_column('digipal_component_features', 'created')

        # Deleting field 'ComponentFeature.modified'
        db.delete_column('digipal_component_features', 'modified')
