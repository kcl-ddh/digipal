...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StewartRecord.matched_hands'
        db.add_column(u'digipal_stewartrecord', 'matched_hands',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StewartRecord.matched_hands'
        db.delete_column(u'digipal_stewartrecord', 'matched_hands')
