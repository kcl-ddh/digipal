...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MediaPermission.is_private'
        db.delete_column(u'digipal_mediapermission', 'is_private')


    def backwards(self, orm):
        # Adding field 'MediaPermission.is_private'
        db.add_column(u'digipal_mediapermission', 'is_private',
