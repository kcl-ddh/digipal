...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TextItemPart'
        db.create_table('digipal_textitempart', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('locus', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('item_part', self.gf('django.db.models.fields.related.ForeignKey')(related_name='text_instances', to=orm['digipal.ItemPart'])),
            ('text', self.gf('django.db.models.fields.related.ForeignKey')(related_name='text_instances', to=orm['digipal.Text'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('digipal', ['TextItemPart'])

        # Adding unique constraint on 'TextItemPart', fields ['item_part', 'text']
        db.create_unique('digipal_textitempart', ['item_part_id', 'text_id'])

        # Adding model 'Text'
        db.create_table('digipal_text', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('digipal', ['Text'])

        # Adding unique constraint on 'Text', fields ['name']
        db.create_unique('digipal_text', ['name'])

        # Adding field 'CatalogueNumber.text'
        db.add_column('digipal_cataloguenumber', 'text',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='catalogue_numbers', null=True, to=orm['digipal.Text']),
                      keep_default=False)


        # Changing field 'CatalogueNumber.historical_item'
        db.alter_column('digipal_cataloguenumber', 'historical_item_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['digipal.HistoricalItem']))
        # Adding field 'Description.text'
        db.add_column('digipal_description', 'text',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='descriptions', null=True, to=orm['digipal.Text']),
                      keep_default=False)


        # Changing field 'Description.historical_item'
        db.alter_column('digipal_description', 'historical_item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['digipal.HistoricalItem'], null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'Text', fields ['name']
        db.delete_unique('digipal_text', ['name'])

        # Removing unique constraint on 'TextItemPart', fields ['item_part', 'text']
        db.delete_unique('digipal_textitempart', ['item_part_id', 'text_id'])

        # Deleting model 'TextItemPart'
        db.delete_table('digipal_textitempart')

        # Deleting model 'Text'
        db.delete_table('digipal_text')

        # Deleting field 'CatalogueNumber.text'
        db.delete_column('digipal_cataloguenumber', 'text_id')


        # Changing field 'CatalogueNumber.historical_item'
        db.alter_column('digipal_cataloguenumber', 'historical_item_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['digipal.HistoricalItem']))
        # Deleting field 'Description.text'
        db.delete_column('digipal_description', 'text_id')


        # Changing field 'Description.historical_item'
        db.alter_column('digipal_description', 'historical_item_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['digipal.HistoricalItem']))
    ...
    models = {
        ...
        'digipal.description': {
            'Meta': {'ordering': "['historical_item', 'text']", 'object_name': 'Description'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'digipal.image': {
            'Meta': {'ordering': "['display_label']", 'object_name': 'Image'},
