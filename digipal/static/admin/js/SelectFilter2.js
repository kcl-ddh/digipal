/*
GN: OPTIMISATION PATCH, search for PATCH below
*/
/*
...
window.SelectFilter = {
    init: function(field_id, field_name, is_stacked, admin_static_prefix) {
        ...
        // GN: PATCH - Optimisation. See https://code.djangoproject.com/ticket/15220
        // appendChild with a long select list is VERY slow in Chrome/Opera 
        //// selector_available.appendChild(from_box);
        jQuery(from_box).detach().appendTo(jQuery(selector_available));
