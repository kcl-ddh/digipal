...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalItem.date_sort'
        db.add_column(u'digipal_historicalitem', 'date_sort',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalItem.date_sort'
        db.delete_column(u'digipal_historicalitem', 'date_sort')
