...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TextContentType.name'
        db.alter_column(u'digipal_text_textcontenttype', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

    def backwards(self, orm):

        # Changing field 'TextContentType.name'
        db.alter_column(u'digipal_text_textcontenttype', 'name', self.gf('django.db.models.fields.CharField')(max_length=40, unique=True))
