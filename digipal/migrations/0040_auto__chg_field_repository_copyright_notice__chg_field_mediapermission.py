...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Repository.copyright_notice'
        db.alter_column('digipal_repository', 'copyright_notice', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'MediaPermission.display_message'
        db.alter_column('digipal_mediapermission', 'display_message', self.gf('tinymce.models.HTMLField')())

        # Changing field 'Reference.full_reference'
        db.alter_column('digipal_reference', 'full_reference', self.gf('tinymce.models.HTMLField')())

        # Changing field 'Description.description'
        db.alter_column('digipal_description', 'description', self.gf('tinymce.models.HTMLField')(null=True))

    def backwards(self, orm):

        # Changing field 'Repository.copyright_notice'
        db.alter_column('digipal_repository', 'copyright_notice', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'MediaPermission.display_message'
        db.alter_column('digipal_mediapermission', 'display_message', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Reference.full_reference'
        db.alter_column('digipal_reference', 'full_reference', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Description.description'
        db.alter_column('digipal_description', 'description', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'digipal.component': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'features': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'components'", 'symmetrical': 'False', 'through': "orm['digipal.ComponentFeature']", 'to': "orm['digipal.Feature']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'})
        },
        'digipal.componentfeature': {
            ...
            'component': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['digipal.Component']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'feature': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['digipal.Feature']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'digipal.image': {
            ...
            'annotation_status': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'images'", 'null': 'True', 'blank': 'True', 'to': "orm['digipal.ImageAnnotationStatus']"}),
