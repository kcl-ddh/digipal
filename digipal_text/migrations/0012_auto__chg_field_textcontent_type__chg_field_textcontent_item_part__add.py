...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TextContent.type'
        db.alter_column(u'digipal_text_textcontent', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['digipal_text.TextContentType']))

        # Changing field 'TextContent.item_part'
        db.alter_column(u'digipal_text_textcontent', 'item_part_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['digipal.ItemPart']))
        # Adding unique constraint on 'TextContent', fields ['item_part', 'type']
        db.create_unique(u'digipal_text_textcontent', ['item_part_id', 'type_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'TextContent', fields ['item_part', 'type']
        db.delete_unique(u'digipal_text_textcontent', ['item_part_id', 'type_id'])


        # Changing field 'TextContent.type'
        db.alter_column(u'digipal_text_textcontent', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['digipal_text.TextContentType']))
    ...
    models = {
        ...
        u'digipal_text.textcontentxmlcopy': {
            'Meta': {'unique_together': "(('content',),)", 'object_name': 'TextContentXMLCopy'},
