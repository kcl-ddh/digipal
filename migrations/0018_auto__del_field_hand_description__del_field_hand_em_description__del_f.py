...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hand.description'
        db.delete_column('digipal_hand', 'description')

        # Deleting field 'Hand.em_description'
        db.delete_column('digipal_hand', 'em_description')

        # Deleting field 'Hand.scragg_description'
        db.delete_column('digipal_hand', 'scragg_description')

        # Deleting field 'Hand.mancass_description'
        db.delete_column('digipal_hand', 'mancass_description')


    def backwards(self, orm):
        # Adding field 'Hand.description'
        db.add_column('digipal_hand', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Hand.em_description'
        db.add_column('digipal_hand', 'em_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Hand.scragg_description'
        db.add_column('digipal_hand', 'scragg_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Hand.mancass_description'
        db.add_column('digipal_hand', 'mancass_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
