...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApiTransform'
        db.create_table(u'digipal_apitransform', (
        ...
        db.send_create_signal(u'digipal', ['ApiTransform'])


    def backwards(self, orm):
        # Deleting model 'ApiTransform'
        db.delete_table(u'digipal_apitransform')
