...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('digipal', ['HandDescription'])

        # Adding field 'Hand.locus'
        db.add_column('digipal_hand', 'locus',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Hand.surrogates'
        db.add_column('digipal_hand', 'surrogates',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Hand.selected_locus'
        db.add_column('digipal_hand', 'selected_locus',
    ...
    def backwards(self, orm):
        # Deleting model 'HandDescription'
        db.delete_table('digipal_handdescription')

        # Deleting field 'Hand.locus'
        db.delete_column('digipal_hand', 'locus')

        # Deleting field 'Hand.surrogates'
        db.delete_column('digipal_hand', 'surrogates')
