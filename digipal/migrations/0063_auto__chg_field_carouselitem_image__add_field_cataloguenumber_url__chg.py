...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'digipal_carouselitem', 'image', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
        # Adding field 'CatalogueNumber.url'
        db.add_column(u'digipal_cataloguenumber', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'CatalogueNumber.number'
        db.alter_column(u'digipal_cataloguenumber', 'number', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'CarouselItem.image'
        db.alter_column(u'digipal_carouselitem', 'image', self.gf('django.db.models.fields.CharField')(default=None, max_length=200))
        # Deleting field 'CatalogueNumber.url'
        db.delete_column(u'digipal_cataloguenumber', 'url')


        # Changing field 'CatalogueNumber.number'
        db.alter_column(u'digipal_cataloguenumber', 'number', self.gf('django.db.models.fields.CharField')(max_length=32))
