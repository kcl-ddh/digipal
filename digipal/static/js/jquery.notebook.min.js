    ...
    var o, a = function() {
        ...
        u = {
            ...
            show: function() {
                ...
                t.length || (t = d.html.addTag(e(this).parent().parent(), "div", !1, !1), t.addClass("jquery-notebook bubble")), t.empty(), u.buildMenu(this, t), t.show(), u.updateState(this, t), t.hasClass("active") ? t.removeClass("jump") : t.addClass("jump"), u.updatePos(e(this), t), t.addClass("active")
            },
            update: function() {
                var t = e(this).parent().parent().find(".bubble");
            ...
            showLinkInput: function(t) {
                ...
                e(this).parent().parent().find(".link-area button").before('<button id="add_link"><span class="glyphicon glyphicon-ok"></span></button>');
                var n = this,
        ...
        f = {
            ...
            focus: function() {
                ...
                u.show.call(this);
                console.log(d.selection.getContainer());
        ...
        m = {
            ...
            change: function() {
                ...
                t.val(e(this).html());
                var n = t.val(),
                    o = new CustomEvent("contentChange", {
                        detail: {
                            content: n
                        }
                    });
