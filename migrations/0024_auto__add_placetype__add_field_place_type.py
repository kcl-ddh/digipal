...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('digipal_placetype', (
        ...
        db.send_create_signal('digipal', ['PlaceType'])

        # Adding field 'Place.type'
        db.add_column('digipal_place', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['digipal.PlaceType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PlaceType'
        db.delete_table('digipal_placetype')

        # Deleting field 'Place.type'
        db.delete_column('digipal_place', 'type_id')
