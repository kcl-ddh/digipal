...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemPart.group_locus'
        db.add_column('digipal_itempart', 'group_locus',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.custom_label'
        db.add_column('digipal_image', 'custom_label',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemPart.group_locus'
        db.delete_column('digipal_itempart', 'group_locus')

        # Deleting field 'Image.custom_label'
        db.delete_column('digipal_image', 'custom_label')
