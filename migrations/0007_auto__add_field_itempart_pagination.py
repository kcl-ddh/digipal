...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemPart.pagination'
        db.add_column('digipal_itempart', 'pagination',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemPart.pagination'
        db.delete_column('digipal_itempart', 'pagination')
