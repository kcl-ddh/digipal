...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TextContentXML.status'
        db.alter_column(u'digipal_text_textcontentxml', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['digipal_text.TextContentXMLStatus']))

    def backwards(self, orm):

        # Changing field 'TextContentXML.status'
        db.alter_column(u'digipal_text_textcontentxml', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['digipal_text.TextContentXMLStatus']))
