...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MediaPermission'
        db.create_table('digipal_mediapermission', (
            ...
            ('display_message', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal('digipal', ['MediaPermission'])

        # Adding field 'Repository.media_permission'
        db.add_column('digipal_repository', 'media_permission',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['digipal.MediaPermission'], null=True),
                      keep_default=False)

        # Adding field 'Page.media_permission'
        db.add_column('digipal_page', 'media_permission',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['digipal.MediaPermission'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MediaPermission'
        db.delete_table('digipal_mediapermission')

        # Deleting field 'Repository.media_permission'
        db.delete_column('digipal_repository', 'media_permission_id')

        # Deleting field 'Page.media_permission'
        db.delete_column('digipal_page', 'media_permission_id')
    ...
    models = {
        ...
        'digipal.page': {
            ...
            'media_permission': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['digipal.MediaPermission']", 'null': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'})
        },
        'digipal.person': {
