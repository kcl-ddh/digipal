...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextContentType.slug'
        db.add_column(u'digipal_text_textcontenttype', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='default', max_length=100),
                      keep_default=False)

        # Adding field 'TextContentXMLStatus.slug'
        db.add_column(u'digipal_text_textcontentxmlstatus', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='default', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextContentType.slug'
        db.delete_column(u'digipal_text_textcontenttype', 'slug')

        # Deleting field 'TextContentXMLStatus.slug'
        db.delete_column(u'digipal_text_textcontentxmlstatus', 'slug')
