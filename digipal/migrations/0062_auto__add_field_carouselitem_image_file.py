...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CarouselItem.image_file'
        db.add_column(u'digipal_carouselitem', 'image_file',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CarouselItem.image_file'
        db.delete_column(u'digipal_carouselitem', 'image_file')
    ...
    models = {
        ...
        u'digipal.carouselitem': {
            ...
            'image_file': ('django.db.models.fields.files.ImageField', [], {'default': 'None', 'max_length': '100', 'null': 'True'}),
