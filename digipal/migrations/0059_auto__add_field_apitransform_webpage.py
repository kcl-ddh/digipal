...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApiTransform.webpage'
        db.add_column(u'digipal_apitransform', 'webpage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApiTransform.webpage'
        db.delete_column(u'digipal_apitransform', 'webpage')
