...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field owners on 'CurrentItem'
        db.create_table('digipal_currentitem_owners', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('currentitem', models.ForeignKey(orm['digipal.currentitem'], null=False)),
            ('owner', models.ForeignKey(orm['digipal.owner'], null=False))
        ))
        db.create_unique('digipal_currentitem_owners', ['currentitem_id', 'owner_id'])


    def backwards(self, orm):
        # Removing M2M table for field owners on 'CurrentItem'
        db.delete_table('digipal_currentitem_owners')
    ...
    models = {
        ...
        'digipal.currentitem': {
            ...
            'legacy_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'owners': ('django.db.models.fields.related.ManyToManyField', [], {'default': 'None', 'to': "orm['digipal.Owner']", 'null': 'True', 'symmetrical': 'False', 'blank': 'True'}),
