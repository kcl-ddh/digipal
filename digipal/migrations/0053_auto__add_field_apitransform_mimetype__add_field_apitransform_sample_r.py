...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApiTransform.mimetype'
        db.add_column(u'digipal_apitransform', 'mimetype',
                      self.gf('django.db.models.fields.CharField')(default='text/xml', max_length=30),
                      keep_default=False)

        # Adding field 'ApiTransform.sample_request'
        db.add_column(u'digipal_apitransform', 'sample_request',
                      self.gf('django.db.models.fields.CharField')(default='graph', max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApiTransform.mimetype'
        db.delete_column(u'digipal_apitransform', 'mimetype')

        # Deleting field 'ApiTransform.sample_request'
        db.delete_column(u'digipal_apitransform', 'sample_request')
