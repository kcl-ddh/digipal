...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Owner.display_label'
        db.add_column(u'digipal_owner', 'display_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Owner.display_label'
        db.delete_column(u'digipal_owner', 'display_label')
