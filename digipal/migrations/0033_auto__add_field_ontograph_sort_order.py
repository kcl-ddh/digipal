...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ontograph.sort_order'
        db.add_column('digipal_ontograph', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ontograph.sort_order'
        db.delete_column('digipal_ontograph', 'sort_order')
    ...
    models = {
        ...
        'digipal.allograph': {
            'Meta': {'ordering': "['character__ontograph__sort_order', 'character__ontograph_type', 'name']", 'unique_together': "(['name', 'character'],)", 'object_name': 'Allograph'},
        ...
        'digipal.character': {
            'Meta': {'ordering': "['ontograph__sort_order', 'ontograph__ontograph_type', 'name']", 'object_name': 'Character'},
        ...
        'digipal.ontograph': {
            'Meta': {'ordering': "['sort_order', 'ontograph_type', 'name']", 'unique_together': "(['name', 'ontograph_type'],)", 'object_name': 'Ontograph'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
